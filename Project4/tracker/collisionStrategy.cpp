...
void RectangularCollisionStrategy::draw() const {
  ...
  IOmod::
  getInstance().writeText("Strategy: Rectangular", 500, 30,color);
}
...
void MidPointCollisionStrategy::draw() const {
  SDL_Color color = {255, 255, 255, 255};
  IOmod::
  getInstance().writeText("Strategy: Distance", 500, 30,color);
}
...
void PerPixelCollisionStrategy::draw() const {
  SDL_Color color = {255, 255, 255, 255};
  IOmod::
  getInstance().writeText("Strategy: Per-Pixel ", 500, 30,color);
}
